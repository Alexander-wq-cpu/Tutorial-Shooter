...
public class WeaponManager : MonoBehaviour
{
    ...
    private void AddWeaponIntoActiveSlot(GameObject pickedupWeapon)
    {
        ...
        pickedupWeapon.transform.localRotation = new Quaternion(weapon.spawnRotation.x, weapon.spawnRotation.y, weapon.spawnRotation.z, weapon.spawnRotation.z);
    ...
    private void DropCurrentWeapon(GameObject pickedupWeapon)
    {
        ...
        {
            var weaponToDrop = activeWeaponSlot.transform.GetChild(0);
